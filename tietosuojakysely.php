...
include "includes/class-feedback-emails.php";
new Iasy_Quiz();
new Iasy_Quiz_Settings();
new Iasy_Localization_Helper();
new Iasy_Feedback_Emails();


if( ! class_exists( 'iasyUpdateChecker' ) ) {

	class iasyUpdateChecker{
		...
		public function __construct() {
			...
			$this->cache_key = 'iasy_custom_upd';
		...
		public function request(){
			...
			if( false === $remote || ! $this->cache_allowed ) {
				...
				$remote = wp_remote_get(
					'https://www.tietosuojaapkyrityksille.fi/tietosuoja-kysely-plugin/info.json',
					array(
						'timeout' => 10,
						'headers' => array(
